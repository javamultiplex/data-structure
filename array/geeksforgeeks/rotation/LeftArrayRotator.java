...
public class LeftArrayRotator {
	...
	public static void main(String[] args) {
		...
		// rotateArrayMethod4(arr, size, rotationCount);
		   rotateArrayMethod5(arr, size, rotationCount);
		System.out.println(Arrays.toString(arr));
		input.close();
	}

	//Block Swap Algorithm = Time - O(n), Space - O(1)
	private static void rotateArrayMethod5(int[] arr, int n, int d) {
	...
	private static void swap(int[] arr, int s, int d, int n) {
